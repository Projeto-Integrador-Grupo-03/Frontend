...
function Home() {
  ...
  return (
    <>
      ...
      <div className="bg-sky-700 bg-cover bg-center flex justify-center">
        <div className="container text-white">
          <div className="flex flex-col gap-4 items-center justify-center py-4">
            <h2 className="text-5xl font-bold">Faça parte do futuro!</h2>
            <p className="text-xl">Movendo-se para um futuro mais verde</p>

            <div className="flex justify-around gap-4">
              <ModalProduto />
              <Link to="/produtos" className="hover:underline">
                <button className="border rounded py-2 px-4 hover:bg-slate-200 hover:text-black">
